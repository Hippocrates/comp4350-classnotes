class Enrollment:
    ...
    def __init__(self, user_id, course_id, enrollment_id=None):
    ...
    def __str__(self):
        ...
        return "Enrolled [enrollment_id=%s, user_id=%s, course_id=%s]" % \
                    (self.enrollment_id, self.user_id, self.course_id)
